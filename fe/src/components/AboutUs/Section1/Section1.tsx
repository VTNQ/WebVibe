...
const Section1 = () => {
    ...
    return (
        <>
            <div className="w-full  space-y-4 text-center mt-4 font-roboto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-blue-600 uppercase leading-snug">
                ...
                <div className="space-y-6 flex justify-start">
                    ...
                    <div className="space-y-4">
                        {faqs.map((faq, index) => (
                            <div
                                key={index}
                                className={`border rounded-lg ${openIndex === index
                            ...
                            >
                                <button
                                    ...
                                    className="w-full relative group overflow-hidden text-left px-4 py-3 flex justify-between items-center font-medium text-blue-700 transition duration-300 rounded-lg"
                                >
                                    ...
                                    <ChevronDown
                                        className={`w-5 h-5 transform transition-transform relative z-10 group-hover:text-white ${openIndex === index ? "rotate-180" : ""
                                            }`}
                                    />

                                    {/* Nền chạy từ trái sang phải */}
                                    <span className="absolute inset-0 z-0 before:absolute before:inset-0 before:bg-white group-hover:before:animate-slide-in group-hover:before:bg-gradient-to-r group-hover:before:from-[#0D5DD6] group-hover:before:to-[#9747FF] before:z-[-1]"></span>
    ...
    `}
                                ...
                                {openIndex === index && faq.answer && (
                                    ...
                                    >
                                        <div className="bg-[#e8f1fa] text-gray-800 text-lg rounded-md p-4 leading-relaxed font-roboto">
                                            {faq.answer}
                                        </div>
                                    </motion.div>
                                )}
                ...
                <div className="relative flex justify-end items-center">
                    ...
                    <img
                        src="img/AboutUs/faq-right.webp" // => bạn thay bằng đúng đường dẫn hình ảnh
                        alt="Web4s FAQ"
                        width={800}
                        height={800}
                        className="z-10"
